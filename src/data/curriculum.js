export const curriculum = [
  ...
  },
  {
    ...
    desc: 'Chuseok holiday (Sep 24–26). No lecture or seminar this week; the schedule resumes on Oct 2.',
    tags: [],
    holiday: true,
  },
  {
  ...
  },
  {
    week: 'W6',
    date: 'TBA',
    note: 'Make-up class — Oct 9 is Hangeul Day (public holiday). Date to be announced.',
  ...
  },
  {
    week: 'W8',
    date: 'Oct 23',
    title: 'Self-Improvement · Midterm Project Presentations',
    desc: 'Lecture: self-reflection, self-correction, self-evolution, and learning from feedback — how agents autonomously improve their own performance over time. Then teams present their midterm progress reports: system design, preliminary results, and revised project plans.',
    tags: ['Self-Reflection', 'Self-Training', 'Learning from Feedback', 'Midterm Report', 'Presentation'],
    readingIdx: 6,
    highlight: true,
  },
  {
